...
namespace Nop.Plugin.Misc.VendorEnhanced.Data
{
    ...
    /// </summary>
    public class VendorReviewObjectContext : DbContext, IDbContext
    {
        #region Ctor
        public VendorReviewObjectContext(DbContextOptions<VendorReviewObjectContext> options) : base(options)
        {
        }
        #endregion
        ...
        {
            modelBuilder.ApplyConfiguration(new VendorReviewMap());
