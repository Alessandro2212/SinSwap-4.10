...
namespace Nop.Plugin.Misc.VendorEnhanced.Data
{
    ...
    /// </summary>
    public class VendorPictureObjectContext : DbContext, IDbContext
    {
        #region Ctor
        public VendorPictureObjectContext(DbContextOptions<VendorPictureObjectContext> options) : base(options)
        {
        }
        #endregion
        ...
        {
            modelBuilder.ApplyConfiguration(new VendorPictureMap());
        ...
        {
            //drop the table
            this.DropPluginTable(nameof(VendorPictureRecord));
        }
        #endregion
    }
}